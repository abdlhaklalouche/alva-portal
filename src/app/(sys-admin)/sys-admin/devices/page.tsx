...
import { devicesKeys, useDevicesActions, useGetDevices } from "@/api/devices";
...
export default () => {
  ...
  const { deleteDevices, isDeletingDevices } = useDevicesActions();
  ...
  const colDefs: ColDef[] = [
    ...
    { field: "room.entity.user.name", headerName: "User", minWidth: 250 },
  ...
  return (
    <PageLayout
      name="Manage Devices"
      description="Manage all devices eg: Fridge, Over, etc.."
      breadcrumbs={[
        {
          name: "Sys Admin",
          link: "/sys-admin",
